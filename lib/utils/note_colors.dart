...
const List<NoteColorDef> noteColors = [
  NoteColorDef(id: 'Yellow', bg: Color(0xFFE6B905), border: Color(0xFFD4A800), text: Colors.black),
  ...
  NoteColorDef(id: 'Default', bg: Color(0xFFE6B905), border: Color(0xFFD4A800), text: Colors.black),
];
